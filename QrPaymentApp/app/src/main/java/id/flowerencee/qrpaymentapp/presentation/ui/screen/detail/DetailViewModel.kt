...
class DetailViewModel(
    ...
    private var _transactionField = MutableStateFlow<ArrayList<TextLabel>>(arrayListOf())
    val transactionField: StateFlow<ArrayList<TextLabel>> get() = _transactionField

    private var _transactionData = MutableStateFlow(Transaction())
    val transactionData: StateFlow<Transaction> get() = _transactionData
